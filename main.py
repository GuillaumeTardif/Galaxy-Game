...
class MainWidget(RelativeLayout):
    ...
    V_NB_LINES = 16
    V_LINES_SPACING = 0.4  # Percentage in screen
    vertical_lines = []

    H_NB_LINES = 10
    H_LINES_SPACING = 0.15  # Percentage in screen
    horizontal_lines = []
    ...
    def is_desktop(self):
        if platform in ('linux', 'win', 'mascosx'):
            return True
        return False
    ...
    def update_ship(self):
        ...
        half_width = self.SHIP_WIDTH / 2 * self.width
    ...
    def update(self, dt):
        ...
        if not self.check_ship_collisions() and not self.state_game_over:
            ...
            Clock.schedule_once(self.play_voice_gameover, 2)
